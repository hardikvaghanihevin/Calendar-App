...
import calendar.schedule.task.todo.event.reminder.databinding.ItemEventLayoutBinding
        ...
        fun bind(event: Event, previousEvent: Event?, position: Int, isMonthView: Boolean = false) {
            binding.apply {
                ...
                eventTimePeriod.text = if (event.isAllDay){
                    ...
                    val startTime = DateUtil.longToString(event.startTime, DateUtil.TIME_FORMAT_HH_mm)
                    "$startTime (${
