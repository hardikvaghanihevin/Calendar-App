...
import calendar.schedule.task.todo.event.reminder.databinding.ItemCountrySelectionBinding
import calendar.schedule.task.todo.event.reminder.databinding.ItemCountrySelectionSmallBinding
...
class CountryAdapter(private val onCountryChecked: (String, Boolean) -> Unit, private val viewType: Int = VERTICAL) : ListAdapter<CountryItem, CountryAdapter.CountryViewHolder>(
    CountryDiffCallback()
) , Filterable {
