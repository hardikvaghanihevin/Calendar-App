package calendar.schedule.task.todo.event.reminder.presentation.ui
...
import calendar.schedule.task.todo.event.reminder.common.Constants.KEY_LANGUAGE_CHANGE_GO_TO_SETTING_FRAG
...
import calendar.schedule.task.todo.event.reminder.common.Constants.PREF_KEY_AUTO_START_PERMISSION
...
import calendar.schedule.task.todo.event.reminder.databinding.ActivityMainBinding
import calendar.schedule.task.todo.event.reminder.databinding.DialogAppThemeBinding
import calendar.schedule.task.todo.event.reminder.databinding.DialogDeviceInformationBinding
import calendar.schedule.task.todo.event.reminder.databinding.DialogFirstDayOfTheWeekBinding
import calendar.schedule.task.todo.event.reminder.databinding.DialogJumpToDateBinding
import calendar.schedule.task.todo.event.reminder.databinding.DialogNotificationPermissionBinding
import calendar.schedule.task.todo.event.reminder.databinding.DialogTimeFormatBinding
import calendar.schedule.task.todo.event.reminder.presentation.MainViewModel
import calendar.schedule.task.todo.event.reminder.presentation.adapter.DrawerMenuAdapter
import calendar.schedule.task.todo.event.reminder.presentation.adapter.DrawerMenuItem
import calendar.schedule.task.todo.event.reminder.presentation.adapter.getDrawableFromAttribute
...
import calendar.schedule.task.todo.event.reminder.utillities.DisplayUtil.showViewWithAnimation
import calendar.schedule.task.todo.event.reminder.utillities.GsonUtil
import calendar.schedule.task.todo.event.reminder.utillities.KeyboardUtils
...
import calendar.schedule.task.todo.event.reminder.utillities.MyNavigation.navOptionsForYear
import calendar.schedule.task.todo.event.reminder.utillities.PermissionHandler
import calendar.schedule.task.todo.event.reminder.utillities.PermissionHandler.openAppSettings
...
class MainActivity : AppCompatActivity() {
    ...
    fun privacyPolicy(context: Context = this) {
        val url = "https://sites.google.com/view/calendar-reminder-todo/" // Replace with your URL
