package calendar.schedule.task.todo.event.reminder.presentation.ui.custom_view
...
import calendar.schedule.task.todo.event.reminder.utillities.DateUtil.getFormattedDate
...
class CustomViewMonth(context: Context, attributeSet: AttributeSet) : FrameLayout(context, attributeSet) {
    ...
    private var weekStart: WeekStart =
        WeekStart.SUNDAY //todo: 0 for Sunday, 1 for Monday (default to Sunday)
